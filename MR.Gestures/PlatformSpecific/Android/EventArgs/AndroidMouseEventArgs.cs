...
{
	public class AndroidMouseEventArgs : MouseEventArgs
	{
		public AndroidMouseEventArgs(MotionEvent previous, MotionEvent current, MouseEventArgs prevArgs, global::Android.Views.View view)
		{
		...
		private Point GetVelocity(MotionEvent previous, MotionEvent current, MouseEventArgs prevArgs)
		{
			if (previous == null)
